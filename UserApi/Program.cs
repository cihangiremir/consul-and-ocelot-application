...
public class Program
{
    public static void Main(string[] args)
    {
        try
        {
            ...
            .AddConsul($"UserApi/appsettings{(Environment.GetEnvironmentVariable("ASPNETCORE_ENVIRONMENT").Contains("Development") ? ".Development" : "")}.json", options =>
            {
    ...
    public static IWebHostBuilder CreateWebHostBuilder(string[] args)
    {
        return new WebHostBuilder()
            ...
            .ConfigureAppConfiguration((hostingContext, config) =>
            {
                ...
                config.AddConsul($"UserApi/appsettings{(hostingContext.HostingEnvironment.IsDevelopment() ? ".Development" : "")}.json", options =>
                     {
                         options.ConsulConfigurationOptions = consulConfOptions =>
                         {
                             consulConfOptions.Address = new Uri(Environment.GetEnvironmentVariable("CONSUL_ENDPOINT"));
